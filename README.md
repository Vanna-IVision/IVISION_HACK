...
Для того, что определить парковочные места были выбраны фотографии с максимальным (или почти максимальным) количеством автомобилей, которые могут быть припаркованы.
